...
export const FACTOS: TextoML[] = [
  ...
  },
  {
    ...
    es: "El Santuario del Bom Jesus do Monte es Patrimonio Mundial de la UNESCO desde 2019.",
    en: "The Bom Jesus do Monte Sanctuary has been a UNESCO World Heritage Site since 2019.",
  },
  {
    pt: "O elevador do Bom Jesus (1882) é o funicular movido a água mais antigo do mundo ainda em funcionamento.",
    es: "El funicular del Bom Jesus (1882) es el funicular movido por agua más antiguo del mundo que sigue en funcionamiento.",
  ...
  },
  {
    ...
    es: "Braga fue elegida Mejor Destino Europeo en 2021.",
  ...
  },
  {
    ...
    es: "El São João de Braga es una de las fiestas populares más grandes y antiguas de Portugal.",
    en: "Braga's São João festival is one of Portugal's biggest and oldest street festivals.",
  },
  {
    pt: "Braga é conhecida como a «Roma portuguesa» pela quantidade de igrejas e património barroco.",
    es: "Braga es conocida como la «Roma portuguesa» por su cantidad de iglesias y patrimonio barroco.",
    en: "Braga is known as the “Portuguese Rome” for its wealth of churches and Baroque heritage.",
  },
];
